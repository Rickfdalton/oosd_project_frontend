...
const displayDetails = () => {
  console.log(
    `hospital:${document.querySelector(".hos-selected").textContent.trim()}`
  );
  console.log(
    `facility:${document.querySelector(".fac-selected").textContent.trim()}`
  );

  window.location.href = "./hospitalpage.html";
};
